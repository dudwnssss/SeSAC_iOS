...
struct CoverPhotoTopicSubmissions: Codable {
    let texturesPatterns, wallpapers, currentEvents, nature: ArchitectureInterior?
...
struct ResultTopicSubmissions: Codable {
    let businessWork, currentEvents, interiors, wallpapers: ArchitectureInterior?
    let architectureInterior: ArchitectureInterior?

    enum CodingKeys: String, CodingKey {
        case businessWork = "business-work"
        case currentEvents = "current-events"
        case interiors, wallpapers
